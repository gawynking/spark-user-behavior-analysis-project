...
public class TaskDAOImpl implements ITaskDAO {
	...
	public Task findById(long taskid) {
		 ...
		 * 
		 * 如果你就用Scala，那么势必会造成与调用第三方组件的代码用java，那么就会变成scala+java混编 大大降低我们的开发和维护的效率
		 * 
		 * 此外，即使，你是用了scala+java混编 但是，真正最方便的，还是使用一些j2ee的开源框架，来进行第三方
		 * 技术的整合和操作，比如MySQL，那么可以用MyBatis/Hibernate，大大减少我们的冗余的代码 大大提升我们的开发速度和效率
		 * 
		 * 但是如果用了scala，那么用j2ee开源框架，进来，造成scala+java+j2ee开源框架混编
		 * 简直会造成你的spark工程的代码上的极度混乱和惨不忍睹 后期非常难以维护和交接
		 * 
		 */
